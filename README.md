...
- [2 - Microservices](#2---microservices)
  ...
  - [2.3 - Comment constriure une application microservice (cas pratique)](doc/microservices.md)
- [3 - Dockerization des microservices](#3---dockerization-des-microservices)
  ...
  - [3.3 - Comment dockeriser une application (cas pratique)](doc/docker.md)
- [4 - Utilisation d'un orchestrateur de conteneurs](#4---utilisation-dun-orchestrateur-de-conteneurs)
  ...
  - [4.3 - Comment intégrer l'orchestrateur de conteneurs à l'application (cas pratique)](doc/kubernetes.md)
- [5 - Déploiement de l'application](#5---déploiement-de-lapplication)
  - [5.1 - Choix du cloud provider](#51---choix-du-cloud-provider)
  - [5.2 - Comment déployer votre application sur le cloud (cas pratique)](doc/deployment.md)
  - [5.3 - Comment gérer les dependances et les ressources de votre application (cas pratique)](doc/kustomize.md)
- [6 - Monitoring et opérations](#6---monitoring-et-opérations)
  ...
  - [6.2 - Comment mettre en place un système de monitoring (cas pratique)](doc/monitoring.md)
  - [6.3 - Comment opérer et maintenir une architecture Cloud Native (cas pratique)](doc/operations.md)
